...
> - `docs/specs/2026-05-30-ai-provider-credential-governance-design.md`
> - `docs/specs/2026-05-31-runtime-slimming-and-target-scope-design.md`
...
- `target` 被定义为视图 / 订阅 / 覆盖范围，而不是运行管道实例。
- 新增国家、地区、主题、实体或风险 target 不触发重复采集和重复事实存储。
