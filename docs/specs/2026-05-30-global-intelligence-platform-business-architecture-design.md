...
密钥治理需要与本地客户端、云端平台和半中心化采集节点共同设计。AI Provider Key、News Sentry 访问 Key、Collector Node Credential 必须分离管理；长期方案见 `docs/specs/2026-05-30-ai-provider-credential-governance-design.md`。
