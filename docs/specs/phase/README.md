...
> 路线图主权文档: [docs/roadmap/development-plan.md](../../roadmap/development-plan.md)
> 架构决策记录: [docs/adr/README.md](../../adr/README.md)
> Phase 12 设计: [docs/specs/2026-05-11-phase-12-source-matrix-design.md](../2026-05-11-phase-12-source-matrix-design.md)
...
| Phase 20 | Quality Feedback Loop | 人工反馈→规则自优化 | ✅ DONE |
...
| Phase 22 | API Gateway | REST API + Webhook 入站 | ✅ DONE |
