...
This plan implements the first executable slice of `docs/global-scale-news-intelligence-architecture.md`:
...
- Modify: `docs/global-scale-news-intelligence-architecture.md`
...
In `docs/global-scale-news-intelligence-architecture.md`, add a short implementation note under `## 5. Markdown 新定位`:
...
```bash
git add docs/architecture.md docs/contracts-canonical.md docs/global-scale-news-intelligence-architecture.md
